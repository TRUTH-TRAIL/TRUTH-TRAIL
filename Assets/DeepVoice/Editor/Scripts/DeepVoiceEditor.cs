...
namespace AiKodexDeepVoice
{
    public class DeepVoiceEditor : EditorWindow
    {
        ...
        void OnGUI()
        {
            ...
            EditorGUILayout.LabelField("                Version 2.1.1", subStyle);
        ...
        IEnumerator Post(string url, string bodyJsonString)
        {
            ...
            else
            {
                ...
                {
                    Debug.Log("Error in prompt: Please check your prompt for quotes (\"\") and line breaks at the end of the prompt. Please also remove any special formatting by pasting as plain text in a notepad and then pasting the text here. Inclusion of any special formaatting or illegal characters will result in an error such as this. For best results, please use a combination of letters, periods and commas and make sure there are no line breaks in between or at the end. If you must use quotes or line breaks, please prepend them with a backslash.");
                }
